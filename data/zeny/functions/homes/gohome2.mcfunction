...
execute if entity @s[tag=home2] if score @s dim2 matches -1 run execute in minecraft:the_nether run tp @s 0.5 2 0.5
execute if entity @s[tag=home2] if score @s dim2 matches 0 run execute in minecraft:overworld run tp @s -194.5 66 -33.5
execute if entity @s[tag=home2] if score @s dim2 matches 1 run execute in minecraft:the_end run tp @s 0.5 1 0.5
