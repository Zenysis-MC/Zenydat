...
scoreboard players operation @s id = @p[scores={home=5}] id
...
execute store result storage zenysis:home Pos[0] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] xHome5
execute store result storage zenysis:home Pos[1] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] yHome5
execute store result storage zenysis:home Pos[2] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] zHome5
