...
scoreboard players operation @s id = @p[scores={home=4}] id
...
execute store result storage zenysis:home Pos[0] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] xHome4
execute store result storage zenysis:home Pos[1] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] yHome4
execute store result storage zenysis:home Pos[2] double 1 run scoreboard players get @a[scores={id_diff=0},limit=1] zHome4
