...
execute if entity @s[tag=!ishoming] run tellraw @a[tag=op] [{"text":"[","color":"gray","italic":"true"},{"selector":"@s","italic":"true"},{"text":" triggered [SetHome 4], but did not have a 4th SetHome.]","color":"gray","italic":"true"}]
...
execute if entity @s[tag=ishoming] run tellraw @a[tag=op] [{"text":"[","color":"gray","italic":"true"},{"selector":"@s","italic":"true"},{"text":" triggered [SetHome 4] sucessfully.]","color":"gray","italic":"true"}]
