...
execute if entity @s[tag=!ishoming] run tellraw @a[tag=op] [{"text":"[","color":"gray","italic":"true"},{"selector":"@s","italic":"true"},{"text":" triggered [SetHome 5], but did not have a 5th SetHome.]","color":"gray","italic":"true"}]
...
execute if entity @s[tag=ishoming] run tellraw @a[tag=op] [{"text":"[","color":"gray","italic":"true"},{"selector":"@s","italic":"true"},{"text":" triggered [SetHome 5] sucessfully.]","color":"gray","italic":"true"}]
