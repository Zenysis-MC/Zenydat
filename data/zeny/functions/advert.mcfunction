...
execute if score advert database matches 1 run tellraw @a ["",{"text":"Want to increase your rank and support the server? Vote by clicking the links on ","color":"gold"},{"text":"/trigger vote","color":"yellow"},{"text":"!","color":"gold"}]
...
schedule function zenydat-main:advert 1200s