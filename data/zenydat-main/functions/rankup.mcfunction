...
execute as @a[scores={starz=2100..},tag=!op,tag=!special,team=!400] run tellraw @a [{"selector":"@s"}," \u00a7bjust ranked up to Martian!"]
execute as @a[scores={starz=2100..},tag=!op,tag=!special,team=!400] run team join 400