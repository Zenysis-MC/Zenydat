...
execute at @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=homer2] if entity @a[scores={home=2},limit=1,sort=nearest] run teleport @a[scores={home=6},limit=1,sort=nearest] @s
